...
class _ProfileScreenState extends State<ProfileScreen>
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, setBS) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          if (stars > 0) ...[
            const SizedBox(height: 8),
            Text(
              ['', 'Bahut bura 😞', 'Thoda theek 😐', 'Accha hai 🙂', 'Bahut accha 😊', 'Ekdum best! 🎉'][stars],
  ...
  // ── Order Tracking Sheet (same as OrderScreen) ───────────
      ...
      children: [
        ...
        _settingsCard([
          ...
          _settingsTile(Icons.help_outline, 'Help & Support',
              'FAQs & contact', Colors.blue, _openHelp),
          _divider(),
  ...
  Widget _infoRow2(IconData icon, String label, String val, Color color) =>
      ListTile(
        leading: Container(
  ...
  Widget _settingsTile(IconData icon, String title, String sub, Color color, VoidCallback onTap) =>
      ListTile(
        onTap: onTap,
        leading: Container(
          padding: const EdgeInsets.all(7),
  ...
  Widget _sheetHeader(IconData icon, String title, Color color) =>
      Row(children: [
        Container(
          padding: const EdgeInsets.all(8),
  ...
  Widget _contactTile(IconData icon, String title, String sub, Color color) =>
      Container(
        margin: const EdgeInsets.only(bottom: 10),
        padding: const EdgeInsets.all(12),
        decoration: BoxDecoration(
